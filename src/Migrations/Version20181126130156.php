 ...
 */
final class Version20181126130156 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', DROP firstname, DROP lastname, DROP phone, DROP picture, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD firstname VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD lastname VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD phone VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, ADD picture VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, DROP roles, CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE email email VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci');
